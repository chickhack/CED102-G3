    ...
    <div class="div-menu">
        <div class="div-list">
            ...
            <div>
                ...
                <a href="./backstage_shop_cmt.php" class="div-list-btn-s now">商品評價</a>
        ...
        <div class="div-right">
            ...
            <div class="title">
                ...
                <div class="data_name h3 div-right-span padding_top_3 line_low">
                    <p class="wi-15 text-1">評價編號</p>
                    <p class="wi-15 text-1">會員編號</p>
                    <p class="wi-15 text-1">商品編號</p>
                    <p class="wi-20 text-1">評價日期</p>
                    <p class="wi-10 text-1">評分</p>
                    <p class="wi-20 text-1">評論</p>
            ...
            <main class="main">
                    <?php while($prodRow = $product->fetch(PDO::FETCH_ASSOC)){?>
                        ...
                        <div class="div-right-span-for line_low margin_top_3">
                                    <p class="wi-15 text-1"><?=$prodRow["prev_no"]?></p>
                                    <a href="../php/backstage/shop/backstage_cmt_customer.php?mem_no=<?=$prodRow["mem_no"]?>"
                                        class="wi-15 text-1"><?=$prodRow ["mem_no"]?></a>
                                    <a href="../php/backstage/shop/backstage_cmt_shop.php?prod_no=<?=$prodRow["prod_no"]?>"
                                        class="wi-15 text-1"><?=$prodRow ["prod_no"]?></a>
                                    <p class="wi-20 text-1"><?=$prodRow["prev_date"]?></p>
                                    <p class="wi-10 text-1"><?=$prodRow["score"]?></p>
                                    <p class="wi-20 text-1 toomuch"><?=$prodRow["prev"]?></p>
                                    <?php
                                            if($prodRow['prev_stats'] == 0){
                                                echo "<p class='wi-15 text-1'><a href='../php/backstage/shop/edit_backstage_shop_cmt.php?prev_no=$prodRow[prev_no]&prev_stats=$prodRow[prev_stats]' name='update' type='button' class='btn btn-primary btn-sm'>顯示</a></p>";
                                            }else{
                                                echo "<p class='wi-15 text-1'><a href='../php/backstage/shop/edit_backstage_shop_cmt.php?prev_no=$prodRow[prev_no]&prev_stats=$prodRow[prev_stats]' name='update' type='button' class='btn btn-danger btn-sm'>隱藏</a></p>";
                                            }
                                        ?>
