        ...
        <div class="card mx-auto h-75 list-group-item list-group-item-light " style="width: 60%;">
            ...
            <ul class="list-group list-group-flush align-middle">
                <form action="edit_backstage_triptoDB.php" method="POST" enctype="multipart/form-data">
                    ...
                    <li class="list-group-item">景點狀態 <input type="number" placeholder="景點狀態" name="spot_status" min="0"
                            max="1" value="<?=$spotRow -> spot_status ?>"></li>
                    <li class="list-group-item">精選景點狀態 <input type="number" placeholder="精選景點狀態" name="spot_s_status" min="0"
